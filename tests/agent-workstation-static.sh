...
require_file_contains agent-workstation/web/index.html "Container Code Companion"
require_file_contains agent-workstation/web/index.html "C.C.C"
require_file_contains agent-workstation/web/index.html "by Parallax Group"
require_file_contains agent-workstation/web/index.html "pllx.group"
require_file_contains agent-workstation/web/index.html "MIT License"
require_file_contains agent-workstation/web/index.html "custom-title-input"
require_file_contains agent-workstation/web/app.js "CCC_CUSTOM_TITLE_STORAGE_KEY"
require_file_contains agent-workstation/web/app.js "bindCustomTitle"
...
require_file_not_contains agent-workstation/web/app.js "Refresh Container Code Companion Status"
...
require_file_contains agent-workstation/web/app.js "runSelfUpdateStream"
require_file_contains agent-workstation/web/app.js "monitorReconnect"
...
require_file_contains agent-workstation/web/app.js "Service restarting"
...
require_file_contains agent-workstation/web/app.js "copyTextToClipboard"
require_file_contains agent-workstation/web/app.js "fallbackCopyText"
require_file_contains agent-workstation/web/app.js "Copy Failed"
require_file_not_contains agent-workstation/web/app.js ".catch(() => {})"
...
require_file_contains agent-workstation/internal/server/server.go "handleSelfUpdate"
...
require_file_contains agent-workstation/internal/system/management.go "Container Code Companion self-update started."
