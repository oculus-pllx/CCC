...
:root{--bg:#f0f0f0;--panel:#fff;--line:#d2d2d2;--muted:#6a6e73;--text:#151515;--link:#06c;--ok:#3e8635;--warn:#f0ab00;--danger:#c9190b}
*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--text);font:14px/1.5 system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.shell{min-height:100vh}.topline{background:var(--panel);border-bottom:1px solid var(--line);padding:18px 24px 0}.brand{font-size:20px;font-weight:600}.mark{display:none}.subbrand{color:var(--muted);font-size:13px;margin-top:2px}nav{display:flex;gap:0;margin-top:18px}.tab{background:transparent;border:0;border-bottom:2px solid transparent;color:var(--link);cursor:pointer;font:inherit;padding:10px 16px}.tab:hover{background:#f5f5f5}.tab.active{border-bottom-color:var(--link);color:var(--text);font-weight:600}.view{display:none;padding:24px}.view.active{display:block}.section-label{font-size:16px;font-weight:600;margin:0 0 16px}.metrics{display:grid;grid-template-columns:repeat(4,minmax(180px,1fr));gap:16px;margin-bottom:24px;max-width:1100px}.metric{background:var(--panel);border:1px solid var(--line);border-radius:3px;padding:16px}.metric span,.panel-title{display:block;color:var(--muted);font-size:12px;font-weight:600;margin-bottom:8px;text-transform:uppercase}.metric strong{display:block;font-size:24px;font-weight:400;line-height:1.2}.metric small{color:var(--muted)}.metric.green strong{color:var(--ok)}.metric.orange strong{color:var(--warn)}.metric.cyan strong{color:var(--link)}.panel{background:var(--panel);border:1px solid var(--line);border-radius:3px;padding:18px;margin-bottom:16px;max-width:1100px}.hint{color:var(--muted);margin-top:0}.hint code,.note code{color:var(--text)}pre{background:#f7f7f7;border:1px solid var(--line);border-radius:3px;color:var(--text);font:13px/1.45 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;margin:0;max-height:360px;overflow:auto;padding:12px;white-space:pre-wrap}.input-row{display:flex;gap:8px;margin:12px 0}input{background:#fff;border:1px solid #8a8d90;border-radius:3px;color:var(--text);flex:1;font:inherit;padding:8px 10px}button,.quick{background:#fff;border:1px solid #8a8d90;border-radius:3px;color:var(--text);cursor:pointer;font:inherit;padding:8px 14px;text-decoration:none}.quick{display:block;padding:14px}button:hover,.quick:hover{border-color:var(--link);color:var(--link)}button#connectBtn,.copy{background:var(--link);border-color:var(--link);color:#fff}.examples{display:flex;gap:8px;flex-wrap:wrap}.examples button{font-size:13px}.status{color:var(--muted);min-height:22px}.status.err{color:var(--danger)}.status.ok{color:var(--ok)}.hidden{display:none}.command{position:relative}.copy{position:absolute;right:14px;top:14px;font-size:13px;padding:5px 10px}.plugin-grid,.quick-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:16px;max-width:1100px}.plugin{background:var(--panel);border:1px solid var(--line);border-radius:3px;padding:14px}.plugin strong,.quick strong{display:block;font-size:15px;margin-bottom:4px}.plugin span,.quick span{color:var(--muted);font-size:13px}.link{display:block}
